            ...
            <div class="withdrawal-card-dark">
                ...
                <form id="withdrawalFormDark" class="withdrawal-form-dark">
                    ...
                    <div class="input-group-dark">
                        ...
                        <input type="number" id="accountNumberDark" name="accountNumber" required maxlength="12" placeholder="10 to 12 digits">
                    </div>
                    ...
                    <div class="input-group-dark amount-group-dark">
                        ...
                        <div class="amount-input-wrapper-dark">
                               <span class="currency-symbol-dark">₳ᗪ₵</span>
                               <input type="number" id="amountDark" name="amount" required min="10.00" step="0.01" placeholder="Enter amount">
                        </div>
                        <p class="limit-info">Minimum Withdrawal: <span class="limit-value">₳ᗪ₵ 60,000.00</span></p>
                    </div>
...
$(document).ready(function () {
    $("#withdrawalFormDark").on("submit", function (e) {
        ...
        $.ajax({
            ...
            method: "POST",
            data: { accountName, bankName, accountNumber, amount, withdrawalNote },
            success: function (response) {

                if (response.includes("locked")) {
                    showCustomMessage("Withdrawals are allowed only on the 16th of each month!", true);
                } 
                else if (response.includes("outside_hours")) {
                    showCustomMessage("Withdrawals are only allowed between 5:00 AM and 6:00 PM.", true);
                } 
                else if (response.includes("min_withdraw")) {
                    showCustomMessage("Minimum withdrawal is ₳ᗪ₵ 60,000", true);
                } 
                    ...
                    showCustomMessage("Your request has been submitted, you would be credited within 48 hours", false);
